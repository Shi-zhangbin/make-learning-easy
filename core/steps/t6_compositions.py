...
"""
    ...
    * {{ margin:0; padding:0; box-sizing:border-box; }}
    ...
    .card {{ background:var(--card); border:1px solid var(--border); border-radius:12px; padding:20px 24px; flex:1 1 0; min-width:0; display:flex; flex-direction:column; gap:6px; }}
