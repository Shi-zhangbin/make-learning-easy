    ...
    def execute(self) -> StepResult:
        ...
        prompt = {
            ...
            "validation_rules": {
                ...
                "forbidden_openers": tone_vrules.get("forbidden_openers", []),
                "tone_keywords_required": tone_vrules.get("tone_keywords_required", []),
                "tone_keywords_min": tone_vrules.get("tone_keywords_min", 1),
            },
